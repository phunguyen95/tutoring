...
export default class PopularCourseIntro extends Component {
  render() {
    return (
        <div className="courses">
        <div className="section_background parallax-window" style={{backgroundImage:"url("+background+")"}}>  
        </div>
			...
			<div className="row courses_row">
				...
				<div className="col-lg-4 course_col">
					<div className="course">
                        ...
                        <img src={require('../../images/course_1.jpg')} alt=""/>
                        </div>
						...
						<div className="course_footer">
							<div className="course_footer_content d-flex flex-row align-items-center justify-content-start">
								<div className="course_info_homepage">
				...
				<div className="col-lg-4 course_col">
					<div className="course">
                        <div className="course_image">
                        <img src={require('../../images/course_2.jpg')} alt=""/>
                        </div>
						<div className="course_body">
				...
				<div className="col-lg-4 course_col">
					<div className="course">
                        <div className="course_image">
                        <img src={require('../../images/course_3.jpg')} alt=""/>
                        </div>
						<div className="course_body">
